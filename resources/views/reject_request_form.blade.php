            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" align="center" style="">
                        <h1 style="width: 100%">Rejection Form Details</h1>
                    </div>
                        ...
                        <form action="accept_request_form", method="post">
                            ...
                            @if(Session::get('success'))
                                <div class="alert alert-success">
                                    {{ 'Your rejection successfully submit !' }}
                                </div>
                            @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="day" type="text" class="form-control{{ $errors->has('day') ? ' is-invalid' : '' }}" name="day" value="{{ $row->day }}" disabled>
