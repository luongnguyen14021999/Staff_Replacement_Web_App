                    ...
                    <div class="card-body">
                        <form action="admin_detail", method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="firstname" value="{{ $row->first_name }}" disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" name="surname" value="{{ $row->surname }}" disabled>
